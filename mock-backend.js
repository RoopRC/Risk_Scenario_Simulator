...
const mockRisks = [
  ...
  {id:9,title:'Interest Rate Hike Impact on Credit Portfolio',description:'Projected 75bp rate increase will affect $2.3B credit portfolio. Expected increase in default rates by 1.8%.',category:'Financial',riskScore:6.2,impact:'HIGH',likelihood:'LOW',status:'IN_PROGRESS',mitigationPlan:'Stress test portfolio under multiple rate scenarios. Adjust risk appetite framework accordingly.',projectedCost:340000,createdAt:'2026-03-05T13:00:00Z',updatedAt:'2026-04-07T17:00:00Z'},
  ...
  {id:15,title:'Revenue Recognition Policy Change Impact',description:'New ASC 606 interpretation affects SaaS revenue timing. Potential $1.2M revenue deferral in Q3.',category:'Financial',riskScore:5.0,impact:'MEDIUM',likelihood:'LOW',status:'OPEN',mitigationPlan:'Engage external auditors for interpretation review. Model financial impact across 3 scenarios.',projectedCost:90000,createdAt:'2026-03-18T09:30:00Z',updatedAt:'2026-04-04T10:30:00Z'},
  ...
  {id:27,title:'Vendor Lock-in Risk with Cloud Provider',description:'85% of infrastructure on single cloud provider. Migration cost estimated at $2.1M if terms change unfavorably.',category:'Strategic',riskScore:5.2,impact:'HIGH',likelihood:'LOW',status:'OPEN',mitigationPlan:'Adopt multi-cloud strategy for new workloads. Containerize top 10 services for portability.',projectedCost:520000,createdAt:'2026-04-09T10:00:00Z',updatedAt:'2026-04-14T08:00:00Z'},
